...
uses
  ...
  RpSystem, RpRave, RpDefine, RpCon, RpConDS, Vcl.ActnList, uPesqProduto;
...
begin
  ...
  begin
    ...
    +QuotedStr(IntToStr(usuConectado))+', '+QuotedStr('Incluido')+', '+QuotedStr(Edit3.Text)+');');
...
procedure TfrmCriarOP.btnPesquisarClick(Sender: TObject);
begin
  pesqProd := 6;
...
procedure TfrmCriarOP.CancelarExecute(Sender: TObject);
begin
  btnCancelarClick(Sender);
end;

procedure TfrmCriarOP.ConfirmarExecute(Sender: TObject);
begin
