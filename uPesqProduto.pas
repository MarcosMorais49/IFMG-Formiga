...
type
  ...
  public
    { Public declarations }
       function retornaUnd(Und:string):string;
  end;

var
  frmPesqProduto: TfrmPesqProduto;
  pesqProd, undcod : integer;
...
begin
  ...
  begin
    ...
    undcod := StrToInt(DBGrid1.Fields[6].AsString);
    frmCadReceita.Edit3.Text := DBGrid1.Fields[1].AsString+' '+retornaUnd(inttostr(undCod));
  ...
  begin
    ...
    undcod := StrToInt(DBGrid1.Fields[6].AsString);
    frmVenda.StringGrid1.Cells[1, temp -1] := DBGrid1.Fields[1].AsString+' '+retornaUnd(inttostr(undCod));
  ...
  begin
    ...
    begin
      ...
      undcod := StrToInt(DBGrid1.Fields[6].AsString);
      frmRelReceitasComponentes.Edit2.Text := DBGrid1.Fields[1].AsString+' '+retornaUnd(inttostr(undCod));
    end;
  end;
  ...
  begin
    ...
    undcod := StrToInt(DBGrid1.Fields[6].AsString);
    frmCriarOP.Edit2.Text := DBGrid1.Fields[1].AsString+' '+retornaUnd(inttostr(undCod));
    frmCriarOP.Edit1.SetFocus;
    end
    else
      ShowMessage('Produto não possui receita cadastrada!');
  end;
...
function TfrmPesqProduto.retornaUnd(Und: string): string;
begin
   frmDM.qryUnidade.Close;
   frmDM.qryUnidade.SQL.Clear;
   frmDM.qryUnidade.SQL.Add('select * from unidade where undCodigo = '+IntToStr(undCod));
   frmDM.qryUnidade.Open;
   result:= frmDM.qryUnidade.FieldByName('undDescricao').Text;
end;
